            ...
            <div class="w-full flex flex-col gap-4">
              ...
              <div class="flex flex-col">
                ...
                <div class="flex">
                  ...
                  <a class="text-sky-600 ml-auto" href="/forgot-password"><small>Forgot password?</small></a>
                </div>
              </div>
              <div class="flex mb-6 justify-between">
                <button onclick={ this.handleLogin } class="py-2 px-3 self-center bg-green-500 hover:bg-green-400 text-white rounded-md">Sign Up</button>
              ...
              <div class="text-center">
                <p>Don't have an account yet? <a class="text-sky-600" href="/register">Create account</a></p>
              </div>
            </div>
          </div>
        </div>
